...
function implement_ajax_deladdondomain() {
	if(isset($_POST['deladdondomain']))
		{
			...
			*/
			...
			$query = 'https://host.knoppys.co.uk:2087/json-api/cpanel?cpanel_jsonapi_user=servicedcitypads&apiversion=2&cpanel_jsonapi_module=addondomain&cpanel_jsonapi_func=deladdondomain&domain='.$addondomain.'&subdomain='.$subStr.'_servicedcitypads.com';
...
add_action('wp_ajax_deladdondomain', 'implement_ajax_deladdondomain');
add_action('wp_ajax_nopriv_deladdondomain', 'implement_ajax_deladdondomain');
